...
def model_inference(best_model, test_loader):
...
if __name__ == '__main__':
    ...
    trn_loader, val_loader, tst_loader = load_cifar10_data(batch=args.batch_size)
    train_model(args, trn_loader, val_loader)
    model_inference(f"best_{args.save_model}.pth", tst_loader)
